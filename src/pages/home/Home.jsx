...
export default function Home() {
    ...
    return (
        <section className="max-w-[100vw] w-full h-full flex flex-col items-center justify-center grow">
            ...
            <button onClick={logout} className="px-[20.0rem] h-[5.5rem] rounded-xl border-[0.2rem] border-[#8930FA] bg-[#8930FA] text-[#f1f1f1] text-[2.0rem] font-medium hover:bg-transparent hover:text-[#8930FA] transtion-all duration-500">
                Logout
            </button>
        </section>
    );
